    ...
    <View>
      ...
      <View style={{height: screenHeight * 0.76, width: '100%', alignSelf: 'center'}}>
        <View style={[styles.containerCenter, {flex: 1}]}>
          <Image style={{height: 80, width: 80}}  source={ImagePaths.no_membership} resizeMode="contain" />
          <Text style={[styles.h4, styles.lineHeightA, {textAlign: 'center', fontWeight: '600', marginVertical: 15 }]}>You have no active {'\n'} membership</Text>
